...
/// <summary> Modifier used with delegates </summary>
public enum Modifier
{
    /// <summary> Weak default value should be 0.5  </summary>
    Weak,
    /// <summary> Base default value should be 1 </summary>
    Base,
    /// <summary> Strong default value should be 1.5 </summary>
    Strong
}
/// <summary> Player's CalculateHealth Delegate </summary>
...
public class Player
{
    /// <summary> EventHanlder for CurrentHPArgs </summary>
    ...
    /// <summary> Player's take damage </summary>
    ...
    /// <summary> Define new player's hp depending on occured event. </summary>
    ...
    /// <summary> Method used with delegate to apply a BaseValue depending on the modifier </summary>
...
{
    /// <summary> currentHp cannot be modified </summary>
    /// <value>Getter only</value>
    public readonly float currentHp;
    /// <summary> Takes a float newHp and sets it as currentHp‘s value </summary>
