...
public interface IBreakable{
    ...
    /// <summary> breaks an item </summary>
    void Break();
}
...
public class Door : Base, IInteractive{
    /// <summary> Door default constructor </summary>
...
public class Decoration : Base, IInteractive, IBreakable{
    ...
    /// <summary> Is quest item boolean </summary>
    ...
    /// <summary> Used for broken item. </summary>
    public void Break(){
        durability -= 1;
        if (durability > 0){
...
/// <summary> Objs enumerable </summary>
