...
public class Queue<T>
{
    ...
    /// If the queue is empty, writes "Queue is empty" to the console and returns the default value of the parameter's type.
    /// </summary>
    /// <returns>The value of the first node in the queue, or the default value of the parameter's type if the queue is empty.</returns>
    public T Peek()
    {
        if (head == null)
        {
    ...
    /// If the queue is empty, writes "Queue is empty" to the console.
    /// </summary>
    public void Print()
    {
        if (head == null)
